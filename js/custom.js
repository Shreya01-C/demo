(function($) {
    ...
    jQuery(".orange-bg").on('click',function(){
      jQuery(".logo-header img").attr("src", "images/logo-red.png");
      jQuery(".footer-logo .text-center img").attr("src", "images/logo-red.png");
      return false;
    });
    
    jQuery(".strong-blue-bg").on('click',function(){
      jQuery(".logo-header img").attr("src", "images/logo-blue.png");
      jQuery(".footer-logo .text-center img").attr("src", "images/logo-blue.png");
      return false;
    });
    
    jQuery(".moderate-green-bg").on('click',function(){
      jQuery(".logo-header img").attr("src", "images/logo-green.png");
      jQuery(".footer-logo .text-center img").attr("src", "images/logo-green.png");
      return false;
    });
    
    jQuery(".vivid-yellow-bg").on('click',function(){
      jQuery(".logo-header img").attr("src", "images/logo-yellow.png");
      jQuery(".footer-logo .text-center img").attr("src", "images/logo-yellow.png");
      return false;
    });
